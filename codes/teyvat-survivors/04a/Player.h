...
public:
    Player() {
        ...
        this->anim_left  = new Animation( ::atlas_player_left, 45 );
        this->anim_right = new Animation( ::atlas_player_right, 45 );
    }
    ~Player() {
    ...
    int GetFrameWidth() const { return this->FRAME_WIDTH; }
    int GetFrameHeight() const { return this->FRAME_HEIGHT; }
private:
    const int SPEED = 3;

...
int main()
{
    ...
    Animation my_animation_peashooter_run_right;

    my_animation_peashooter_run_right.set_atlas(&atlas_peashooter_run_right);
    my_animation_peashooter_run_right.set_interval( 75 );
    my_animation_peashooter_run_right.set_loop( true );

    Animation my_animation_peashooter_run_right1;

    my_animation_peashooter_run_right1.set_atlas(&atlas_peashooter_run_right);
    my_animation_peashooter_run_right1.set_interval( 75 );
    my_animation_peashooter_run_right1.set_loop( true );

    Animation my_animation_peashooter_run_right2;

    my_animation_peashooter_run_right2.set_atlas(&atlas_peashooter_run_right);
    my_animation_peashooter_run_right2.set_interval( 75 );
    my_animation_peashooter_run_right2.set_loop( true );

    Animation my_animation_peashooter_run_right3;

    my_animation_peashooter_run_right3.set_atlas(&atlas_peashooter_run_right);
    my_animation_peashooter_run_right3.set_interval( 75 );
    my_animation_peashooter_run_right3.set_loop( true );
    ...
    while( true ){
        ...
        my_animation_peashooter_run_right.on_update_test( 1 );
        my_animation_peashooter_run_right1.on_update_test2( 1 );

        static DWORD last_tick_time = GetTickCount();
        DWORD current_tick_time = GetTickCount();
        DWORD delta_tick = current_tick_time - last_tick_time;
        my_animation_peashooter_run_right2.on_update_test3(delta_tick);
        my_animation_peashooter_run_right3.on_update(delta_tick);
        menu_scene->on_update( delta_tick );
        ...
        if ( iidx == 1 ) {
            ...
            putimage_alpha( 100, 100, atlas_peashooter_run_right.get_image( 1 ) );
            putimage_alpha( 300, 100, &img_peashooter_run_2 );
        }
        else if ( iidx == 3 ) {
            putimage_alpha( 100, 100, atlas_peashooter_run_right.get_image( 2 ) );
            putimage_alpha( 300, 100, &img_peashooter_run_3 );
        }
        else if ( iidx == 4 ) {
            putimage_alpha( 100, 100, atlas_peashooter_run_right.get_image( 3 ) );
            putimage_alpha( 300, 100, &img_peashooter_run_4 );
        }
        else if ( iidx == 5 ) {
            putimage_alpha( 100, 100, atlas_peashooter_run_right.get_image( 4 ) );
            putimage_alpha( 300, 100, &img_peashooter_run_5 );
        }

        my_animation_peashooter_run_right.on_draw_test( 100, 200, iidx - 1 );
        my_animation_peashooter_run_right.on_draw_test1( 100, 300 );

        my_animation_peashooter_run_right1.on_draw_test1( 100, 400 );
        my_animation_peashooter_run_right2.on_draw_test1( 100, 500 );
        my_animation_peashooter_run_right3.on_draw( 300, 500 );
        menu_scene->on_draw();

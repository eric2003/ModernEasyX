...
public:
    ...
    void on_enter() {
        ...
        this->animation_peashooter_run_right.set_interval( 300 );
        this->animation_peashooter_run_right.set_loop( false );
        this->animation_peashooter_run_right.set_callback(
            []() {
                std::cout << "void on_enter() set_callback\n";
